...
public class Fitness {
	...
	private String bmiResult;   // getter만 만듦
	...
	public String toString() {
		String data = String.format("%2d %s %s %.2fcm %.2fKg 표준체중: %.2f BMI: %.2f %s%n", id, name, gender, height, weight, StdWeight,
				bmi, bmiResult);     // format은 문자열만 만들고, 출력은 X  + printf와 형식 동일
		return data;
	}
